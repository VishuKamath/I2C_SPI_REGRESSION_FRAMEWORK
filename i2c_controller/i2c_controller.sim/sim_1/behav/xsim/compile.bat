...
REM
REM Generated by Vivado on Tue Mar 24 23:23:54 +0530 2026
...
echo "xvlog --incr --relax -prj i2c_controller_tb_vlog.prj"
call xvlog  --incr --relax -prj i2c_controller_tb_vlog.prj -log xvlog.log
